...
void main(uint64_t arg0, uint64_t arg1, uint64_t arg2, uint64_t arg3, uint64_t arg4, uint64_t arg5, uint64_t arg6)
{
	...
	do
	{
		...
		if ((__zext uint32_t)(phi13 != 255) < ~phi13)
		{
			...
			if (anon24 == 255)
			{
				...
				phi_in22 = (__zext uint64_t)(anon25 + anon26);
				phi_in23 = 255;
			}
			uint64_t phi27 = phi_in22;
			uint32_t phi28 = phi_in23;
			phi_in2 = phi7;
			phi_in3 = phi27;
			phi_in10 = anon19;
			phi_in4 = phi11 + 1 & 0xffffffff;
			uint32_t anon29 = phi28 - 2;
	...
	if (!((__zext uint32_t)(phi13 == 255) < ~phi13 | (phi11 & 1) == 0))
	{
		...
		uint64_t anon30 = phi8 & 0xffffffff;
		main(4195952, anon21, (__zext uint64_t)phi13, arg3, phi7, phi11 << 32 >> 32 >> 1 & 0xffffffff, anon30);
		uint64_t anon31 = (__zext uint64_t)((uint32_t)phi12 - anon20 - alloca1.field1);
		main(4195982, anon21, anon31, arg3, 0, 0, anon30);
		main(4196002, anon21, anon31, arg3, phi7, 0, anon30);
	}
	return;
}
