						...
						*anon4 = 0;
						...
						if (*anon5 != 0 || *anon5 == 0 && phi26)
						{
							...
							if (*(uint8_t*)(phi30 + 3) == 0)
							{
								...
								if (*phi29 == 254)
								{
									uint8_t anon55 = *(uint8_t*)(phi30 + 1) & 1;
									*(uint8_t*)(*anon19 + ((__sext int64_t)*anon8 ^ 0xffffffffffffffff) - (__zext uint64_t)(anon55 ^ 1)) = anon55;
									puts((uint8_t*)*anon19);
									uint8_t anon56 = *(uint8_t*)(*anon1 + 1) & 1;
									*(uint8_t*)(*anon19 + ((__sext int64_t)*anon8 ^ 0xffffffffffffffff) - (__zext uint64_t)anon56) = anon56;
									puts((uint8_t*)*anon19);
								}
							}
							else 
