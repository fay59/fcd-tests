	...
	if ((uint32_t)arg2 > 2)
	{
		...
		if (anon2 != null)
		{
			...
			while (true)
			{
				...
				if (dispatch3 == 5 || dispatch3 == 2 && phi17 < (uint32_t)phi18 || anon10 != 0 && dispatch3 == 6 && phi17 < (uint32_t)phi18 || anon4 != null && anon10 != 0 && dispatch3 == 0 && phi17 < (uint32_t)phi18)
				{
					phi20 = phi_in19;
					anon22 = arg1 - 400;
					anon23 = phi20 + 1;
				...
				if (anon21 != 0 && (dispatch3 == 5 || dispatch3 == 2 && phi17 < (uint32_t)phi18 || anon10 != 0 && dispatch3 == 6 && phi17 < (uint32_t)phi18 || anon4 != null && anon10 != 0 && dispatch3 == 0 && phi17 < (uint32_t)phi18))
				{
					phi_in24 = *(uint8_t*)(anon22 + (__sext int64_t)anon23 + 80);
					phi_in25 = 0;
				}
				if (dispatch3 == 1 || anon21 != 0 && dispatch3 == 5 || anon21 != 0 && dispatch3 == 2 && phi17 < (uint32_t)phi18 || anon10 != 0 && anon21 != 0 && dispatch3 == 6 && phi17 < (uint32_t)phi18 || anon4 != null && anon10 != 0 && anon21 != 0 && dispatch3 == 0 && phi17 < (uint32_t)phi18)
				{
				...
				if (anon28 == 0 && (dispatch3 == 1 || anon21 != 0 && dispatch3 == 5 || anon21 != 0 && dispatch3 == 2 && phi17 < (uint32_t)phi18 || anon10 != 0 && anon21 != 0 && dispatch3 == 6 && phi17 < (uint32_t)phi18 || anon4 != null && anon10 != 0 && anon21 != 0 && dispatch3 == 0 && phi17 < (uint32_t)phi18))
				{
				...
				if (dispatch3 == 4 || anon32 != 0 && dispatch3 == 1 && anon28 == 0 || anon21 != 0 && anon32 != 0 && dispatch3 == 5 && anon28 == 0 || anon21 != 0 && anon32 != 0 && dispatch3 == 2 && phi17 < (uint32_t)phi18 && anon28 == 0 || anon10 != 0 && anon21 != 0 && anon32 != 0 && dispatch3 == 6 && phi17 < (uint32_t)phi18 && anon28 == 0 || anon4 != null && anon10 != 0 && anon21 != 0 && anon32 != 0 && dispatch3 == 0 && phi17 < (uint32_t)phi18 && anon28 == 0)
				{
				...
				if (anon28 == 0 && anon32 == 0 && (dispatch3 == 1 || anon21 != 0 && dispatch3 == 5 || anon21 != 0 && dispatch3 == 2 && phi17 < (uint32_t)phi18 || anon10 != 0 && anon21 != 0 && dispatch3 == 6 && phi17 < (uint32_t)phi18 || anon4 != null && anon10 != 0 && anon21 != 0 && dispatch3 == 0 && phi17 < (uint32_t)phi18))
				{
					printf((uint8_t*)anon7);
					phi_in40 = anon7;
				}
				if (dispatch3 == 3 || dispatch3 == 1 && anon28 == 0 && anon32 == 0 || anon21 != 0 && dispatch3 == 5 && anon28 == 0 && anon32 == 0 || anon21 != 0 && dispatch3 == 2 && phi17 < (uint32_t)phi18 && anon28 == 0 && anon32 == 0 || anon10 != 0 && anon21 != 0 && dispatch3 == 6 && phi17 < (uint32_t)phi18 && anon28 == 0 && anon32 == 0 || anon4 != null && anon10 != 0 && anon21 != 0 && dispatch3 == 0 && phi17 < (uint32_t)phi18 && anon28 == 0 && anon32 == 0)
				{
