	...
	if ((uint32_t)arg2 > 2)
	{
		...
		if (anon2 != null)
		{
			...
			while (true)
			{
				...
				if (dispatch3 == 1 || dispatch3 == 6 && anon9 != 0)
				{
					phi15 = phi_in13;
					phi16 = phi_in14;
					phi_in17 = phi15;
				...
				if (dispatch3 == 5 || dispatch3 == 1 && phi15 < (uint32_t)phi16 || dispatch3 == 6 && anon9 != 0 && phi15 < (uint32_t)phi16)
				{
					phi18 = phi_in17;
					anon20 = arg1 - 400;
					anon21 = phi18 + 1;
				...
				if (anon19 != 0 && (dispatch3 == 5 || dispatch3 == 1 && phi15 < (uint32_t)phi16 || dispatch3 == 6 && anon9 != 0 && phi15 < (uint32_t)phi16))
				{
					phi_in22 = *(uint8_t*)(anon20 + (__sext int64_t)anon21 + 80);
					phi_in23 = 0;
				}
				if (dispatch3 == 4 || anon19 != 0 && dispatch3 == 5 || anon19 != 0 && dispatch3 == 1 && phi15 < (uint32_t)phi16 || anon19 != 0 && dispatch3 == 6 && anon9 != 0 && phi15 < (uint32_t)phi16)
				{
				...
				if (anon26 == 0 && (dispatch3 == 4 || anon19 != 0 && dispatch3 == 5 || anon19 != 0 && dispatch3 == 1 && phi15 < (uint32_t)phi16 || anon19 != 0 && dispatch3 == 6 && anon9 != 0 && phi15 < (uint32_t)phi16))
				{
					*(uint8_t*)(anon20 + (anon28 << 32 >> 32) + 48) = 0;
					SD(4195996, (uint64_t)&alloca1.field6, (uint64_t)&alloca1.field11);
					phi_in29 = anon6;
				}
				uint8_t anon30 = alloca1.field4 ^ alloca1.field9 | alloca1.field1 ^ alloca1.field6 | alloca1.field2 ^ alloca1.field7 | alloca1.field3 ^ alloca1.field8;
				if (dispatch3 == 3 || anon30 != 0 && dispatch3 == 4 && anon26 == 0 || anon19 != 0 && anon30 != 0 && dispatch3 == 5 && anon26 == 0 || anon19 != 0 && anon30 != 0 && dispatch3 == 1 && phi15 < (uint32_t)phi16 && anon26 == 0 || anon19 != 0 && anon30 != 0 && dispatch3 == 6 && anon9 != 0 && phi15 < (uint32_t)phi16 && anon26 == 0)
				{
					uint64_t phi31 = phi_in29;
					uint64_t anon32 = phi31 + 4;
					phi_in29 = anon32;
					dispatch3 = 3;
					uint16_t anon34 = (uint16_t)*(uint32_t*)(phi31 & 0xffffffff);
					uint16_t anon33 = anon34 - 257 & (anon34 ^ 0x8080) & 0x8080;
					if (anon33 != 0)
					{
						uint8_t anon36 = (uint8_t)anon33;
						struct { uint8_t field0; bool field1; } anon35 = llvm.uadd.with.overflow.i8(anon36, anon36);
						phi_in13 = anon27;
						phi_in14 = (__zext uint64_t)((uint32_t)anon32 - 3 - (__zext uint32_t)anon35.field1 - anon4);
						dispatch3 = 1;
					}
				}
				if (anon26 == 0 && anon30 == 0 && (dispatch3 == 4 || anon19 != 0 && dispatch3 == 5 || anon19 != 0 && dispatch3 == 1 && phi15 < (uint32_t)phi16 || anon19 != 0 && dispatch3 == 6 && anon9 != 0 && phi15 < (uint32_t)phi16))
				{
					printf((uint8_t*)anon6);
					phi_in37 = anon6;
				}
				if (dispatch3 == 2 || dispatch3 == 4 && anon26 == 0 && anon30 == 0 || anon19 != 0 && dispatch3 == 5 && anon26 == 0 && anon30 == 0 || anon19 != 0 && dispatch3 == 1 && phi15 < (uint32_t)phi16 && anon26 == 0 && anon30 == 0 || anon19 != 0 && dispatch3 == 6 && anon9 != 0 && phi15 < (uint32_t)phi16 && anon26 == 0 && anon30 == 0)
				{
					uint64_t phi38 = phi_in37;
					...
					if (anon40 != 0)
					{
						...
						phi_in13 = (uint32_t)anon39 - 3 - (__zext uint32_t)anon42.field1 - anon4;
						phi_in14 = phi38 + 1 - (__zext uint64_t)anon42.field1 - anon6;
						dispatch3 = 1;
					}
				}
			}
