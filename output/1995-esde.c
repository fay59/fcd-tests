			...
			do
			{
				...
				if (anon3 != null)
				{
					...
					while (phi_in11 < phi_in12)
					{
						...
						while (anon14 == 0);
						*(uint8_t*)(anon15 + phi17 + 48) = *(uint8_t*)(anon15 + (__sext int64_t)anon16 + 80);
						uint64_t phi_in18 = 0;
						do
						{
							phi17 = phi_in18;
							anon20 = phi_in11 + 2 + (uint32_t)phi17;
							anon19 = isalpha((__sext int32_t)*(uint8_t*)(anon15 + (__sext int64_t)anon20 + 80));
							if (anon19 != 0)
							{
								*(uint8_t*)(anon15 + phi17 + 48) = *(uint8_t*)(anon15 + (__sext int64_t)anon20 + 80);
								phi_in18 = (phi17 & 0xffffffff) + 1;
							}
						}
						while (anon19 != 0);
						*(uint8_t*)(anon15 + ((phi17 << 32) + 4294967296 >> 32) + 48) = 0;
						SD(4195996, (uint64_t)&alloca1.field5, (uint64_t)&alloca1.field10);
						uint64_t phi_in21 = anon5;
						uint64_t phi_in22 = (__zext uint64_t)anon13;
						if ((*(uint8_t*)((arg1 + 4294966896 & 0xffffffff) + 19) ^ alloca1.field8 | alloca1.field1 ^ alloca1.field5 | alloca1.field2 ^ alloca1.field6 | alloca1.field3 ^ alloca1.field7) == 0)
						{
							...
							uint64_t phi_in23 = anon5;
							do
							{
								anon24 = (phi_in23 & 0xffffffff) + 4;
								phi_in23 = anon24;
								uint16_t anon26 = (uint16_t)*(uint32_t*)phi_in23;
								anon25 = anon26 - 257 & (anon26 ^ 0x8080) & 0x8080;
							}
							while (anon25 == 0);
							uint8_t anon28 = (uint8_t)anon25;
							uint32_t anon27 = (uint32_t)anon24 - 3 - (__zext uint32_t)llvm.uadd.with.overflow.i8(anon28, anon28).field1 - anon13;
							phi_in11 = anon27;
							phi_in12 = anon27;
						}
						else 
						{
							...
							do
							{
								anon29 = (phi_in21 & 0xffffffff) + 4;
								phi_in21 = anon29;
								phi_in22 = anon29;
								uint16_t anon31 = (uint16_t)*(uint32_t*)phi_in22;
								anon30 = anon31 - 257 & (anon31 ^ 0x8080) & 0x8080;
							}
							while (anon30 == 0);
							uint8_t anon33 = (uint8_t)anon30;
							struct { uint8_t field0; bool field1; } anon32 = llvm.uadd.with.overflow.i8(anon33, anon33);
							phi_in11 = anon20;
							phi_in12 = (uint32_t)anon29 - 3 - (__zext uint32_t)anon32.field1 - anon13;
						}
					}
				}
			}
