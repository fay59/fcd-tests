...
void main(uint64_t arg0, uint64_t arg1)
{
	...
	*(uint64_t*)anon1 = anon2;
	do
	{
		...
		if (anon3 != 0 && *anon4 != 0 && (uint32_t)(uint64_t)gets(anon6) != 0 && (uint32_t)(uint64_t)gets(*(uint8_t**)anon1) != 0)
		{
			uint64_t anon14;
			uint32_t anon17;
			uint32_t anon70;
			...
			do
			{
				...
				if (*(uint32_t*)(anon1 + anon30 + 384) != 0)
				{
					...
					while (true)
					{
						...
						{
							phi_in60 = phi44;
							uint64_t phi_in61 = phi47;
							phi62 = phi_in60;
							phi63 = (uint32_t)(((__sext int64_t)*(uint8_t*)(__sext int64_t)(*(uint32_t*)(anon1 + (phi_in61 << 2) + 384) / 64 + 4197048) - 4) % 10) + 48;
							phi64 = phi_in61;
							break;
						}
						if (*(uint32_t*)(anon14 + anon33) != 0 && anon50 != anon51 && anon43 == 2 || anon59 != 60 && *(uint32_t*)(anon14 + anon33) == 0)
						{
							uint64_t phi_in65 = phi54;
							phi56 = phi_in65;
							phi57 = phi55;
						...
						if (*(uint32_t*)(anon14 + anon33) != 0 && anon50 != anon51 && anon43 == 2 || anon59 != 60 && *(uint32_t*)(anon14 + anon33) == 0 || anon43 != 2 && *(uint32_t*)(anon14 + anon33) != 0 && anon50 != anon51)
						{
							...
							phi64 = phi57;
							phi62 = phi_in60;
							phi63 = (__sext int32_t)*(uint8_t*)(phi58 + 4197048);
							break;
						}
					}
					phi_in29 = phi62;
				...
				uint64_t phi68 = phi_in29;
				anon70 = (uint32_t)phi68;
				uint32_t anon69 = anon70 + 1;
				phi23 = (__zext uint64_t)anon69;
				phi24 = anon69;
			}
			while (anon70 < 119);
			putchar(10);
