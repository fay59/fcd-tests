			...
			if ((uint32_t)(uint64_t)anon7 != 0)
			{
				...
				if ((uint32_t)(uint64_t)anon10 != 0)
				{
					...
					do
					{
						...
						if (*(uint32_t*)(anon1 + anon32 + 384) != 0)
						{
							...
							while (true)
							{
								...
								if (*(uint32_t*)(anon17 + anon35) != 0)
								{
									...
									uint32_t phi41 = *(uint32_t*)(anon1 + (phi38 + phi_in26 << 32 >> 30) + 384);
									uint8_t anon42 = (uint8_t)(phi38 * 3) & 0x1f;
									if (anon42 != 0)
									{
										phi41 = (uint32_t)((__zext uint64_t)*(uint32_t*)(anon1 + (phi38 + phi_in26 << 32 >> 30) + 384) << (__zext uint64_t)anon42);
									}
									anon43 = phi39 + phi41;
									*(uint32_t*)(anon17 + phi34) = anon43;
									...
									uint64_t anon47 = phi_in26 + anon48 + 4294967295 & 0xffffffff;
									phi_in46 = anon47;
									uint32_t anon51 = (uint32_t)phi_in26 + phi40;
									...
									if (anon52 != anon53)
									{
										phi55 = anon47;
										phi56 = anon50;
										phi_in46 = (__zext uint64_t)anon51;
										phi57 = anon50;
										phi58 = 2;
									}
								}
								...
								uint32_t anon59 = (uint32_t)((__sext int64_t)*(uint32_t*)(anon1 + anon32 + 384) % 64);
								if (*(uint32_t*)(anon17 + anon35) != 0 && anon52 == anon53 || *(uint32_t*)(anon17 + anon35) == 0 && anon59 == 60)
								{
									phi60 = phi_in46;
									phi61 = (uint32_t)(((__sext int64_t)*(uint8_t*)(__sext int64_t)(*(uint32_t*)(anon1 + (phi_in49 << 2) + 384) / 64 + 4197048) - 4) % 10) + 48;
									anon62 = (uint64_t*)(arg1 - 3368);
									*anon62 = phi_in49;
									break;
								}
								if (*(uint32_t*)(anon17 + anon35) != 0 && anon52 != anon53 && anon45 == 2 || anon59 != 60 && *(uint32_t*)(anon17 + anon35) == 0)
								{
									phi_in46 = phi55;
									phi57 = phi56;
									phi58 = (__sext int64_t)*(uint32_t*)(anon1 + (phi56 << 2) + 384);
								}
								if (*(uint32_t*)(anon17 + anon35) != 0 && anon52 != anon53 && anon45 == 2 || anon59 != 60 && *(uint32_t*)(anon17 + anon35) == 0 || anon45 != 2 && *(uint32_t*)(anon17 + anon35) != 0 && anon52 != anon53)
								{
									phi_in49 = phi57;
									phi60 = phi_in46;
									phi61 = (__sext int32_t)*(uint8_t*)(phi58 + 4197048);
									*anon62 = phi_in49;
									break;
								}
							}
						...
						uint64_t phi64 = phi_in26;
						anon66 = (uint32_t)phi64;
						uint32_t anon65 = anon66 + 1;
						phi_in26 = (__zext uint64_t)anon65;
						phi27 = anon65;
					}
					while (anon66 < 119);
					putchar(10);
