					...
					do
					{
						...
						if (*(uint32_t*)(anon1 + anon28 + 384) != 0)
						{
							...
							else 
							{
								...
								do
								{
									uint32_t phi_in39 = *(uint32_t*)(anon1 + (phi34 + phi_in21 << 32 >> 30) + 384);
									uint8_t anon40 = (uint8_t)(phi34 * 3) & 0x1f;
									if (anon40 != 0)
									{
										phi_in39 = (uint32_t)((__zext uint64_t)*(uint32_t*)(anon1 + (phi34 + phi_in21 << 32 >> 30) + 384) << (__zext uint64_t)anon40);
									}
								...
								uint64_t anon46 = phi_in21 + anon44 + 4294967295 & 0xffffffff;
								phi_in35 = anon46;
								uint32_t anon48 = (uint32_t)phi_in21 + phi33;
								...
								if (anon49 != anon50)
								{
									phi_in37 = anon46;
									phi38 = anon47;
									phi52 = (__zext uint64_t)anon48;
									phi53 = anon47;
									phi54 = 2;
								}
							}
							uint32_t anon55 = (uint32_t)((__sext int64_t)*(uint32_t*)(anon1 + anon28 + 384) % 64);
							if (*(uint32_t*)(anon12 + anon31) != 0 && anon49 == anon50 || *(uint32_t*)(anon12 + anon31) == 0 && anon55 == 60)
							{
								phi56 = phi_in35;
								phi57 = (uint32_t)(((__sext int64_t)*(uint8_t*)(__sext int64_t)(*(uint32_t*)(anon1 + (phi_in36 << 2) + 384) / 64 + 4197048) - 4) % 10) + 48;
								phi58 = phi_in36;
							}
							if (*(uint32_t*)(anon12 + anon31) != 0 && anon49 != anon50 && anon43 == 2 || anon55 != 60 && *(uint32_t*)(anon12 + anon31) == 0)
							{
								phi53 = phi38;
								phi52 = phi_in37;
								phi54 = (__sext int64_t)*(uint32_t*)(anon1 + (phi53 << 2) + 384);
							}
							if (*(uint32_t*)(anon12 + anon31) != 0 && anon49 != anon50 && anon43 == 2 || anon55 != 60 && *(uint32_t*)(anon12 + anon31) == 0 || *(uint32_t*)(anon12 + anon31) != 0 && anon43 != 2 && anon49 != anon50)
							{
								phi_in35 = phi52;
								phi_in36 = phi53;
								phi56 = phi_in35;
