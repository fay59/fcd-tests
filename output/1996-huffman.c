					...
					do
					{
						...
						if (*(uint32_t*)(anon1 + anon31 + 384) != 0)
						{
							...
							if (anon54 != 60 && *(uint32_t*)(anon16 + anon34) == 0 || *(uint32_t*)(anon16 + anon34) != 0 && anon55 != anon56 && anon48 == 2)
							{
								phi_in38 = phi40;
								phi61 = phi41;
								phi62 = (__sext int64_t)*(uint32_t*)(anon1 + (phi61 << 2) + 384);
							}
							if (anon54 != 60 && *(uint32_t*)(anon16 + anon34) == 0 || *(uint32_t*)(anon16 + anon34) != 0 && anon55 != anon56 && anon48 == 2 || *(uint32_t*)(anon16 + anon34) != 0 && anon55 != anon56 && anon48 != 2)
							{
								phi60 = phi61;
								phi_in30 = phi_in38;
								phi59 = (__sext int32_t)*(uint8_t*)(phi62 + 4197048);
							}
						...
						uint64_t phi65 = phi_in30;
						anon67 = (uint32_t)phi65;
						uint32_t anon66 = anon67 + 1;
						phi24 = (__zext uint64_t)anon66;
						phi25 = anon66;
					}
					while (anon67 < 119);
					putchar(10);
