	...
	*anon1 = anon2;
	...
	if (anon3 == 0)
	{
		...
		if ((anon5 | anon6) == 0)
		{
			...
			phi_in10 = (__zext uint32_t)((uint8_t)arg2 | anon11);
		}
		else 
		{
			phi_in10 = (__zext uint32_t)((__zext uint8_t)((arg2 & 0xff) == 0) | anon11 ^ 1);
			if (anon8 != 0)
			{
				phi_in10 = (uint32_t)((__zext uint64_t)((__zext uint32_t)((arg2 & 0xff) == 0) | anon6 ^ 1) << anon9);
			}
		}
	...
	uint8_t anon15 = (uint8_t)arg2 | anon11;
	else if (anon15 != 0)
	{
		anon17 = arg2 & 0xff;
		anon16 = anon7 & (__zext uint32_t)(anon17 != 0);
		*anon13 = (anon8 == 0 ? anon16 : (uint32_t)((__zext uint64_t)anon16 << anon9)) | anon2;
		phi_in14 = 0;
	}
	bool anon18 = anon16 == 1 | (anon7 & 1) == 0 | anon17 == 0;
	bool anon19 = anon6 == 0 | anon5 == 0;
	if (anon3 != 0 && anon15 != 0 && anon18 || !anon19 && anon3 == 0)
	{
		phi_in14 = 1;
	}
	if (anon3 != 0 && anon15 != 0 && anon18 || !anon19 && anon3 == 0 || anon3 == 0 && anon19 || anon3 != 0 && !anon18 && anon15 != 0)
	{
	...
	if (anon3 != 0 && anon15 == 0)
	{
		*anon13 = (anon8 == 0 ? 1 : (uint32_t)(1 << anon9)) | anon2;
		return 0;
	}
}
