...
void func_4001fb(uint64_t arg0, uint64_t arg1)
{
	...
	while (true)
	{
		...
		if (dispatch5 == 0 || phi7 != 21 && dispatch5 == 1 && ((uint32_t)(phi7 >> 63) | (__zext uint32_t)(phi7 == 0)) == 0)
		{
			phi8 = phi_in1;
			uint64_t phi9 = phi_in2;
			phi_in10 = phi9;
		}
		if (dispatch5 == 2 || dispatch5 == 0 || phi7 != 21 && dispatch5 == 1 && ((uint32_t)(phi7 >> 63) | (__zext uint32_t)(phi7 == 0)) == 0)
		{
