...
void main(uint64_t arg0, uint64_t arg1)
{
	...
	*(uint64_t*)0x601951 = 72340172838076673;
	...
	uint64_t phi_in5 = 6297816;
	uint64_t phi_in6 = 16;
	while (phi_in6 != 0)
	{
		*(uint64_t*)phi_in5 = 72340172838076673;
		phi_in5 = phi_in5 + 8;
		phi_in6 = phi_in6 - 1;
	}
	*(uint64_t*)0x604492 = 72340172838076673;
	*(uint64_t*)0x604511 = 72340172838076673;
	uint64_t phi_in7 = 6309016;
	uint64_t phi_in8 = 16;
	while (phi_in8 != 0)
	{
		*(uint64_t*)phi_in7 = 72340172838076673;
		phi_in7 = phi_in7 + 8;
		phi_in8 = phi_in8 - 1;
	}
	...
	do
	{
		uint32_t anon22;
		uint32_t phi_in13 = 0;
		uint64_t phi_in14 = 1 - phi_in10 + 6296192;
		uint64_t phi_in15 = 6296192 - phi_in10;
		uint64_t phi_in16 = phi_in10;
		do
		{
			uint64_t anon17 = phi_in16 + phi_in15;
			uint64_t anon18 = 480 - phi_in10;
			uint64_t anon19 = 160 - phi_in10;
			uint64_t anon20 = 320 - phi_in10;
			uint64_t anon21 = phi_in16 + phi_in14;
			putchar((__sext int32_t)*(phi_in13 < 79 ? (uint8_t*)((__sext int64_t)(((__sext int32_t)*(uint8_t*)(anon17 + anon18) + ((__sext int32_t)*(uint8_t*)(anon17 + anon19) << 2) + ((__sext int32_t)*(uint8_t*)phi_in15 << 3) + ((__sext int32_t)*(uint8_t*)(anon17 + anon20) << 1) << 4) + ((__sext int32_t)*(uint8_t*)phi_in14 << 3) + ((__sext int32_t)*(uint8_t*)(anon21 + anon19) << 2) + ((__sext int32_t)*(uint8_t*)(anon21 + anon20) << 1) + (__sext int32_t)*(uint8_t*)(anon21 + anon18) + 1) + 4196472) : (uint8_t*)0x400878));
			anon22 = phi_in13 + 177 & 0xff;
			if (anon22 != 0)
			{
				phi_in13 = phi_in13 + 1;
				phi_in14 = (phi_in14 & 0xf) + 2;
				phi_in15 = phi_in15 + 2;
				phi_in16 = 0;
			}
		}
		while (anon22 != 0);
		phi_in10 = phi_in10 - 640;
	}
	while (phi_in10 != -14720);
	return;
}
