...
void main(uint64_t arg0, uint64_t arg1)
{
	...
	*(uint64_t*)0x601a80 = 4195648;
	...
	if (*anon2 == 0 && *anon5 < 1840 || *anon2 != 0 && phi_in14 == 1839 || *anon5 >= 1840 && *anon2 == 0 && phi_in14 == 1839)
	{
		*anon2 = 1840;
	...
	while (true)
	{
		...
		if (phi_in17 == 1840)
		{
			...
			uint64_t anon28 = (__zext uint64_t)phi13;
			...
			if (anon30 != 128)
			{
				...
				uint64_t phi36;
				uint32_t phi39;
				uint32_t anon31 = (uint32_t)(anon28 * 1717986919 >> 37) - (phi13 >> 31);
				alloca1.field1 = anon31 + 1;
				alloca1.field2 = (__sext int64_t)phi13;
				alloca1.field0 = phi13 + anon31 * 4294967216 + 1;
				phi32 = anon19;
				do
				{
				...
				uint32_t anon40 = *anon35 + (uint32_t)(anon28 + phi36);
				*(uint8_t*)((__sext int64_t)anon40 + 6296384) = 32;
				uint32_t anon41 = phi13 + (uint32_t)phi36;
				...
				*(uint8_t*)(phi32 - 18) = 32;
				...
				(*(void(**)(uint64_t))0x601a80)((__zext uint64_t)(phi13 + (*anon35 << 1)));
				phi18 = anon43;
				phi_in20 = *anon2;
			}
		}
		if (phi_in17 != 1840 || *anon2 != 1840 && anon30 != 128)
		{
			phi_in29 = phi18;
			phi46 = phi_in29;
			phi47 = phi13;
		...
		if (*anon3 == phi13)
		{
			if (phi_in17 != 1840 || anon30 != 128 && (*anon2 != 1840 || (__sext int32_t)*(uint8_t*)(*(uint64_t*)(phi32 + 38) + 6296384) + (__sext int32_t)*(uint8_t*)(*(uint64_t*)(phi32 + 54) + 6296384) + (__sext int32_t)*(uint8_t*)(*(uint64_t*)(phi32 + 30) + 6296384) + (__sext int32_t)*(uint8_t*)(*(uint64_t*)(phi32 + 46) + 6296384) == 128) || anon30 == 128)
			{
				uint64_t phi_in50 = phi46;
				*anon2 = 1;
		...
		if (phi_in17 == 1840 && anon30 == 128 && *anon3 == phi13 || phi_in17 == 1840 && anon30 != 128 && *anon2 == 1840 && (__sext int32_t)*(uint8_t*)(*(uint64_t*)(phi32 + 38) + 6296384) + (__sext int32_t)*(uint8_t*)(*(uint64_t*)(phi32 + 54) + 6296384) + (__sext int32_t)*(uint8_t*)(*(uint64_t*)(phi32 + 30) + 6296384) + (__sext int32_t)*(uint8_t*)(*(uint64_t*)(phi32 + 46) + 6296384) == 128 && *anon3 == phi13 || phi_in17 != 1840 && *anon3 == phi13 || *anon2 != 1840 && phi_in17 == 1840 && anon30 != 128 && *anon3 == phi13 || phi_in17 != 1840 && *anon3 != phi13 || *anon2 != 1840 && *anon3 != phi13 && phi_in17 == 1840 && anon30 != 128)
		{
			if (phi49 == 1)
			{
				int64_t anon54 = (__sext int64_t)phi47;
				...
				if (*anon53 == 32)
				{
					...
					*anon53 = 46;
					...
					else if ((uint32_t)(*anon62)((__zext uint64_t)(phi47 + 1), anon61) == 0)
					{
						if ((uint32_t)(*anon62)((__zext uint64_t)(phi47 + 80), (__zext uint64_t)*anon55) == 0)
						{
							if ((uint32_t)(*anon62)((__zext uint64_t)(phi47 - 80), (__zext uint64_t)*anon55) == 0)
							{
								if ((uint32_t)(*anon62)((__zext uint64_t)(phi47 - 1), (__zext uint64_t)*anon55) == 0)
								{
									*anon53 = 32;
