...
void main(uint64_t arg0, uint64_t arg1, uint64_t arg2)
{
	...
	do
	{
		...
		if (anon4 != 0)
		{
			...
			*(uint8_t*)(*(uint64_t*)(arg2 + 32) + (__sext int64_t)*(uint8_t*)(*(uint64_t*)((anon4 << 3) + arg2) + (__sext int64_t)*(uint32_t*)(((uint64_t)anon5 << 32 >> 32) + (anon4 << 2)))) = *(uint8_t*)(*(uint64_t*)(arg2 + 24) + anon4);
			phi_in2 = anon4;
		}
	}
	while (anon4 != 0);
