	...
	while (true)
	{
		...
		do
		{
			...
			do
			{
				...
				anon10 = phi8 + (uint32_t)m.constprop.0(4195644, (__zext uint64_t)phi6, (__zext uint64_t)phi9);
				phi_in5 = anon10;
				anon11 = phi9 + 1;
				phi_in7 = anon11;
			}
		...
		uint64_t phi_in29 = phi13;
		uint64_t phi30 = phi_in14;
		uint32_t phi31 = phi15;
		uint64_t phi32 = phi_in12;
		uint64_t phi33 = phi_in29;
		uint64_t phi34 = 1;
		uint32_t phi35 = 1;
		uint64_t anon36 = m.constprop.1(4195713, (__zext uint64_t)phi31, (__zext uint64_t)phi35);
		...
		phi32 = phi41;
		phi33 = phi42;
		if (phi43 != 0 && (uint32_t)m.constprop.1(4196072, phi32 & 0xffffffff, 0) != 0)
		{
			uint32_t anon51;
			putchar(10);
			uint64_t phi45 = 65;
			...
			if (*(uint32_t*)(((__sext int64_t)((uint32_t)arg2 + *(uint32_t*)(phi6 + 6296832)) + (__sext int64_t)((uint32_t)arg1 + *(uint32_t*)(phi6 + 6296896)) * 10 << 2) + 6297408) == 1)
			{
				...
				if (*(uint32_t*)(anon13 + ((__zext uint64_t)-anon14 << 2) + ((-anon15 << 2) - anon15 << 3)) == 255)
				{
					...
					do
					{
						...
						*(uint32_t*)phi16 = 0;
						uint64_t anon20 = (__zext uint64_t)((uint32_t)phi5 + *(uint32_t*)phi18);
						phi7 = anon20;
						anon21 = (uint32_t)phi19 - 1;
						if (anon21 != 0)
						{
