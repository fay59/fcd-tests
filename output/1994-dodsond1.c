		...
		*anon1 = 1;
		...
		do
		{
			...
			if (*(uint32_t*)(((__sext int64_t)((uint32_t)arg2 + *(uint32_t*)(phi8 + 6296832)) + (__sext int64_t)((uint32_t)arg1 + *(uint32_t*)(phi8 + 6296896)) * 10 << 2) + 6297408) == 4294967295)
			{
				phi10 = 1;
				phi11 = 1;
				phi12 = (((__zext uint64_t)*(uint32_t*)(phi8 + 6296832) << 33 >> 32) + anon3 + (((__zext uint64_t)*(uint32_t*)(phi8 + 6296896) << 33 >> 32) + anon4) * 10 << 2) + 6297408;
				uint32_t phi_in13 = phi10;
				phi5 = phi5;
				phi9 = phi6;
				int64_t anon15 = (__sext int64_t)*(uint32_t*)(phi8 + 6296832);
				int64_t anon16 = (__sext int64_t)*(uint32_t*)(phi8 + 6296896);
				anon14 = phi12 + (anon15 + anon16 * 10 << 2);
				if (*(uint32_t*)(anon14 + (-anon15 << 2) + ((-anon16 << 2) - anon16 << 3)) == 1)
				{
					uint32_t anon23;
					uint32_t anon19 = (uint32_t)phi11;
					...
					uint64_t phi20 = anon18 + 6296960;
					do
					{
						uint32_t phi21 = phi_in13;
						*(uint32_t*)phi17 = 0;
						uint32_t anon22 = phi6 + *(uint32_t*)phi20;
						phi5 = anon22;
						phi9 = anon22;
						anon23 = phi21 - 1;
						phi_in13 = anon23;
						int64_t anon24 = (__sext int64_t)-*(uint32_t*)(phi8 + 6296832) + (__sext int64_t)-*(uint32_t*)(phi8 + 6296896) * 10 << 2;
						phi17 = phi17 + anon24;
						phi6 = anon22;
						phi20 = phi20 + anon24;
					}
		...
		*anon1 = 4294967295;
		...
		do
		{
			...
			if (*(uint32_t*)(((__sext int64_t)((uint32_t)arg2 + *(uint32_t*)(phi8 + 6296832)) + (__sext int64_t)((uint32_t)arg1 + *(uint32_t*)(phi8 + 6296896)) * 10 << 2) + 6297408) == 1)
			{
				...
				phi9 = phi5;
				phi10 = phi_in6;
				int64_t anon16 = (__sext int64_t)*(uint32_t*)(phi8 + 6296832);
				int64_t anon17 = (__sext int64_t)*(uint32_t*)(phi8 + 6296896);
				anon15 = phi13 + (anon16 + anon17 * 10 << 2);
				if (*(uint32_t*)(anon15 + (-anon16 << 2) + ((-anon17 << 2) - anon17 << 3)) == 255)
				{
					uint32_t anon25;
					uint32_t anon20 = (uint32_t)phi12;
					int64_t anon19 = (__sext int64_t)(*(uint32_t*)(phi8 + 6296832) * anon20) + anon3 + ((__sext int64_t)(*(uint32_t*)(phi8 + 6296896) * anon20) + anon4) * 10 << 2;
