			...
			do
			{
				...
				if (anon37 > anon39)
				{
					...
					*(uint32_t*)(arg1 - 72) = anon40;
					phi_in41 = (__zext uint64_t)anon37;
					phi42 = anon37;
					phi_in43 = anon40;
				}
				else 
				...
				if (phi44 != 8)
				{
					...
					phi32 = (__zext uint64_t)anon45;
					phi33 = (uint32_t)phi_in2;
					phi34 = anon45;
				}
			}
			while (phi44 != 8);
			anon46 = (uint32_t)phi_in2;
			if (anon46 != 8)
			{
				phi_in12 = phi_in41;
