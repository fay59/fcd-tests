			...
			*anon20 = 0;
			...
			if ((*anon8 >> 31 | (__zext uint32_t)(*anon8 == 0)) == 0)
			{
				...
				do
				{
					alloca1.field0 = 32;
					uint32_t phi23 = 32;
					int64_t anon24 = (__sext int64_t)phi22 << 2;
					if (phi21 < *(uint32_t*)(anon10 + anon24 + 128))
					{
						fseek(*anon2, (__sext int64_t)(phi21 + *(uint32_t*)(anon10 + anon24 + 528)), 0);
