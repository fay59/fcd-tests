...
void main(uint64_t arg0, uint64_t arg1, uint64_t arg2)
{
	...
	while (true)
	{
		...
		*anon24 = *(uint64_t*)0x601298;
		...
		uint64_t phi_in41 = *(uint64_t*)0x601298;
		...
		if (anon44 != 255)
		{
			while (true)
			{
				...
				*anon47 = phi_in41;
				...
				if (((uint32_t)(phi42 >> 63) | (__zext uint32_t)(phi42 == 0)) == 0)
				{
					...
					do
					{
						...
						if ((phi53 & 2 | 1) == 1)
						{
							...
							{
								uint64_t anon60 = phi54 << 32 >> 28;
								uint64_t* anon59 = (uint64_t*)(anon60 + 6296392);
								uint64_t anon61 = *anon59 * *(uint64_t*)(phi55 + 16);
								*anon59 = anon61;
								uint64_t* anon62 = (uint64_t*)(anon60 + 6296384);
								*anon62 = *anon62 * *(uint64_t*)(phi55 + 24);
								phi58 = phi54;
								if (anon61 <= -1)
								{
						...
						{
							uint32_t anon64 = (uint32_t)phi54 + 1;
							int64_t anon63 = (__sext int64_t)anon64 << 4;
							*(uint64_t*)(anon63 + 6296384) = *(uint64_t*)(phi55 + 16);
							*(uint64_t*)(anon63 + 6296392) = *(uint64_t*)(phi55 + 24);
							phi58 = (__zext uint64_t)anon64;
						}
						uint64_t anon66 = phi57 | phi56 & 0xffffffff;
						anon65 = anon66 + 2;
						if (*anon23 >= anon65)
						{
							uint64_t anon67 = anon66 + 1;
							phi_in51 = anon67;
							phi_in52 = anon67 & 0xffffffff00000000;
							phi53 = phi53 >> 2;
							phi54 = phi58;
							phi55 = phi55 + 16;
						}
					...
					if (((uint32_t)(*anon23 >> 63) | (__zext uint32_t)(*anon23 == 0)) == 0)
					{
						...
						uint64_t phi70 = *anon46;
						uint64_t phi71 = 0;
						uint32_t phi_in72 = 0;
						uint64_t phi73 = phi43;
						uint64_t phi74 = *anon46;
						uint64_t phi_in75 = *anon47;
						do
						{
							uint32_t phi76 = phi_in72;
							uint32_t phi77 = phi68;
							uint32_t phi78 = phi69;
							uint64_t phi79 = phi70;
							uint64_t phi80 = phi71;
							uint64_t phi81 = phi_in75;
							if ((phi73 & 2 | 1) != 1)
							{
								uint32_t anon84 = (uint32_t)phi71 + 1;
								int64_t anon83 = (__sext int64_t)anon84 << 4;
								uint64_t anon85 = (__zext uint64_t)phi69 << 32 | (__zext uint64_t)phi68;
								uint64_t anon82 = ((phi73 << 1 & 2 ^ 2) - 1) * *(uint64_t*)(anon83 + 6296384) * anon85 + phi70 * *(uint64_t*)(anon83 + 6296392);
								*anon46 = anon82;
								uint64_t anon86 = anon85 * *(uint64_t*)(anon83 + 6296392);
								*anon47 = anon86;
								phi77 = (uint32_t)anon86;
								phi78 = (uint32_t)(anon86 >> 32);
								phi79 = anon82;
								phi80 = (__zext uint64_t)anon84;
								phi74 = anon82;
								phi81 = anon86;
							}
							phi49 = phi74;
				...
				uint64_t phi88 = phi49;
				uint64_t phi89 = 0;
				if (phi50 != 0)
				{
					uint64_t phi90 = phi50;
					uint64_t phi_in91 = phi88;
					uint64_t phi_in92 = phi50;
					if (phi88 != 0)
					{
						uint64_t anon95;
						do
					...
					uint64_t anon96 = (uint64_t)((__sext int128_t)phi88 / anon97);
					*anon46 = anon96;
					uint64_t anon99 = (uint64_t)((__sext int128_t)phi50 / anon97);
					*anon47 = anon99;
					phi89 = anon99;
					phi88 = anon96;
				}
				if (*(uint64_t*)0x6012b8 != 0 && *(uint64_t*)0x6012b8 != phi89 && *(uint64_t*)0x6012b0 == phi88 && phi43 == 256)
				{
					break;
				}
				if (*(uint64_t*)0x6012b8 == 0 || *(uint64_t*)0x6012b8 != 0 && *(uint64_t*)0x6012b0 == phi88 && *(uint64_t*)0x6012b8 == phi89)
				{
					...
					if ((((uint32_t)(phi48 >> 63) ^ 1) & (__zext uint32_t)(phi48 != 0)) != 0)
					{
						...
						do
						{
							...
							uint32_t anon106 = printf(*(uint64_t*)(phi103 | 8) == 1 ? anon107 : anon12);
							*anon13 = anon106;
							uint32_t anon108 = printf((uint8_t*)0x400b5c);
							*anon13 = anon108;
							anon109 = phi104 | (__zext uint64_t)phi105;
							if (anon109 < *anon5)
							{
								uint64_t anon110 = anon109 + 1;
								phi_in101 = anon110 & 0xffffffff00000000;
								phi_in102 = (uint32_t)anon110;
								phi103 = phi103 + 16;
							}
						}
						while (anon109 < *anon5);
					...
					uint32_t anon111 = printf(*(uint64_t*)((phi100 << 4) + 6296712) == 1 ? anon107 : anon12);
					*anon13 = anon111;
					uint32_t anon112 = printf((uint8_t*)0x400b61);
					*anon13 = anon112;
					uint32_t anon113 = printf(*anon47 == 1 ? anon107 : anon12);
					*anon13 = anon113;
					uint32_t anon114 = printf((uint8_t*)0x400b65);
					*anon13 = anon114;
				}
				if ((*(uint64_t*)0x6012b8 == 0 || *(uint64_t*)0x6012b8 != 0 && *(uint64_t*)0x6012b0 == phi88 && *(uint64_t*)0x6012b8 == phi89 || *(uint64_t*)0x6012b8 != 0 && *(uint64_t*)0x6012b0 != phi88) && phi43 == 256)
				{
					break;
				}
				if (phi43 != 256 && (*(uint64_t*)0x6012b8 == 0 || *(uint64_t*)0x6012b8 != 0 && *(uint64_t*)0x6012b0 == phi88 && *(uint64_t*)0x6012b8 == phi89 || *(uint64_t*)0x6012b8 != 0 && *(uint64_t*)0x6012b0 != phi88 || *(uint64_t*)0x6012b8 != 0 && *(uint64_t*)0x6012b8 != phi89 && *(uint64_t*)0x6012b0 == phi88))
				{
					phi_in41 = *anon24;
					phi42 = *anon5;
					phi43 = phi43 - 1;
		...
		break;
		uint64_t anon115 = (phi7 | phi8 & 0xffffffff) + 1;
		phi_in1 = anon115 & 0xffffffff00000000;
		phi_in2 = anon115;
		uint64_t anon116 = phi9 + 16;
		phi_in3 = anon116;
		phi_in4 = (uint64_t*)anon116;
		phi6 = (uint32_t)anon115;
	}
	return;
}
