...
void main(uint64_t arg0, uint64_t arg1, uint64_t arg2)
{
	...
	while (true)
	{
		...
		*anon24 = *(uint64_t*)0x601298;
						...
						do
						{
							...
							if ((phi74 & 2 | 1) != 1)
							{
								...
								*anon48 = anon89;
								...
								phi81 = (uint32_t)(anon89 >> 32);
								phi82 = anon85;
								phi_in83 = (__zext uint64_t)anon87;
								phi78 = anon85;
								phi84 = anon89;
							}
							phi49 = *anon23;
		...
		break;
		uint64_t anon118 = (phi7 | phi8 & 0xffffffff) + 1;
		phi_in1 = anon118 & 0xffffffff00000000;
		phi_in2 = anon118;
		uint64_t anon119 = phi9 + 16;
		phi_in3 = anon119;
		phi_in4 = (uint64_t*)anon119;
