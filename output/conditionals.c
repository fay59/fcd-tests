...
uint32_t main(uint32_t arg0, uint8_t** arg1)
{
	...
	uint64_t anon3 = (__zext uint64_t)(arg0 + 2);
	uint64_t anon1 = testO_64(4194946, anon2, anon3);
	uint64_t anon5 = anon2 + 2 & 0xffffffff;
	uint64_t anon4 = testO_32(4194960, anon2, anon5);
	uint64_t anon6 = testNO_64(4194974, anon2, anon5);
	uint64_t anon7 = testNO_32(4194988, anon2, anon3);
	uint64_t anon8 = testB_64(4195002, anon2, anon5);
	uint64_t anon9 = testB_32(4195016, anon2, anon5);
	uint64_t anon10 = testAE_64(4195030, anon2, anon5);
	uint64_t anon11 = testAE_32(4195044, anon2, anon5);
	uint64_t anon12 = testE_64(4195058, anon2, anon5);
	uint64_t anon13 = testE_32(4195072, anon2, anon5);
	uint64_t anon14 = testNZ_64(4195086, anon2, anon5);
	uint64_t anon15 = testNZ_32(4195100, anon2, anon5);
	uint64_t anon16 = testNA_64(4195114, anon2, anon5);
	uint64_t anon17 = testNA_32(4195128, anon2, anon5);
	uint64_t anon18 = testNBE_64(4195142, anon2, anon5);
	testNBE_32(4195156, anon2, anon5);
	testS_64(4195170, anon2, anon5);
	testS_32(4195184, anon2, anon5);
	testNS_64(4195198, anon2, anon5);
	testNS_32(4195212, anon2, anon5);
	testPE_64(4195226, anon2, anon5);
	testPE_32(4195240, anon2, anon5);
	testPO_64(4195254, anon2, anon5);
	testPO_32(4195268, anon2, anon5);
	testNGE_64(4195282, anon2, anon5);
	testNGE_32(4195296, anon2, anon5);
	testNL_64(4195310, anon2, anon5);
	testNL_32(4195324, anon2, anon5);
	testNG_64(4195338, anon2, anon5);
	testNG_32(4195352, anon2, anon5);
	testNLE_64(4195366, anon2, anon5);
	testNLE_32(4195380, anon2, anon5);
	return (uint32_t)(anon18 | anon17 | anon16 | anon15 | anon14 | anon13 | anon12 | anon11 | anon10 | anon9 | anon8 | anon7 | anon6 | anon4 | anon1);
}
