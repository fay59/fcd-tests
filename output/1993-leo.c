	...
	if (anon13 != null)
	{
		...
		*(uint16_t*)(**anon47 == 0 ? phi16 : anon46) = *(uint16_t*)(anon12 + ((__sext int64_t)rand() % (__zext uint64_t)phi17 << 32 >> 31));
		...
		do
		{
				...
				if (**anon47 == 0)
				{
					if (**anon47 == 0 && **anon47 == 0 || **anon47 != 0 && **anon47 == 0 && **anon47 == 0 || **anon47 != 0 && **anon47 != 0)
					{
						...
						*anon69 = phi95 >> 12 | phi95 << 4;
						...
						alloca1.field5 = (__zext uint16_t)((uint16_t)phi107 < 4096) + phi106 + phi76 + (phi67 + phi56 + phi60 + phi63 << 4 | phi74) + phi78 + phi79 + phi89 + phi91 + phi93 + phi94 + phi103 + phi105;
						alloca5 = 0;
			...
			alloca1.field1 = 0;
			anon108 = (uint32_t)phi48;
			if (anon108 != 0)
			{
				uint16_t phi226;
				uint64_t anon109 = (__zext uint64_t)alloca1.field4;
				alloca5 = anon109;
				uint64_t phi_in110 = anon12;
				uint64_t phi111 = 0;
				while (true)
				{
					uint64_t phi_in115;
					...
					uint16_t phi121 = phi_in117;
					uint16_t phi_in122 = phi_in117 ^ *(uint16_t*)phi112;
					...
					if (phi119 < 16)
					{
						...
						phi121 = anon125;
						phi_in122 = *(uint16_t*)phi112 ^ anon125;
						phi123 = phi_in118;
					}
					uint16_t phi_in126 = phi121;
					uint64_t phi_in127 = phi_in120;
					uint16_t phi128 = phi_in122;
					uint16_t phi129 = 0;
					if ((phi_in122 & 0xf00) == 0)
					{
					...
					uint64_t phi132 = phi_in127;
					uint16_t phi133 = 0;
					uint16_t phi134 = phi_in126;
					if (phi128 < 4096)
					{
						uint16_t anon135 = phi_in126 | 0xf000;
						phi132 = phi_in127 & 0xffffffffffff0000 | (__zext uint64_t)anon135;
						phi133 = 256;
						phi134 = anon135;
					}
					...
					uint64_t phi154 = phi_in143;
					uint16_t phi155 = 0;
					if (phi150 < 16)
					{
						uint64_t anon156 = phi_in143 & 0xffffffffffffff00 | phi149 & 0xf | 0xf0;
						phi154 = anon156;
					...
					uint64_t phi158 = phi154;
					uint16_t phi159 = phi152;
					uint16_t anon161 = *(uint16_t*)phi112 ^ phi153;
					phi160 = anon161;
					uint16_t phi162 = 0;
					if ((anon161 & 0xf00) == 0)
					{
						uint64_t anon163 = phi158 & 0xffffffffffff00ff | phi145 << 8 & 0xf000 | 0xf00;
						phi158 = anon163;
					...
					if (phi182 < 16)
					{
						uint64_t anon188 = phi_in184 & 0xffffffffffffff00 | phi181 & 0xf | 0xf0;
						phi_in184 = anon188;
					...
					uint16_t phi_in190 = phi185;
					uint64_t phi191 = phi_in184;
					uint16_t anon193 = *(uint16_t*)phi112 ^ phi186;
					phi192 = anon193;
					uint16_t phi194 = 0;
					if ((anon193 & 0xf00) == 0)
					{
						uint64_t anon195 = phi_in184 & 0xffffffffffff00ff | phi180 << 8 & 0xf000 | 0xf00;
						phi191 = anon195;
					...
					uint64_t phi197 = phi191;
					uint16_t phi198 = 0;
					uint16_t phi199 = phi_in190;
					if (phi192 < 4096)
					{
						uint16_t anon200 = phi_in190 | 0xf000;
						phi197 = phi197 & 0xffffffffffff0000 | (__zext uint64_t)anon200;
						phi198 = 256;
						phi199 = anon200;
					}
					uint16_t anon207 = phi199 << 4;
					uint16_t anon206 = phi199 >> 12 | anon207;
					...
					else 
					{
						phi208 = anon204;
						phi_in210 = anon202;
						phi212 = (__zext uint64_t)(phi199 >> 4);
						phi213 = anon206;
						phi215 = anon205;
						phi216 = (uint8_t)anon201 & 0xf;
						phi217 = 0;
					}
					uint64_t phi_in218 = phi208;
					if (phi216 < 16)
					{
						uint64_t anon220 = phi_in218 & 0xffffffffffffff00 | phi215 & 0xf | 0xf0;
						phi219 = anon220;
						phi221 = (__zext uint32_t)(*(uint16_t*)phi112 ^ (uint16_t)anon220);
						phi222 = anon137 ^ (uint32_t)anon220;
						phi223 = 256;
					}
					else 
					{
						phi219 = phi_in218;
						phi221 = phi_in210;
						phi222 = (__zext uint32_t)(*(uint16_t*)phi112 ^ phi213);
						phi223 = 0;
					}
					uint32_t phi224 = phi221;
					uint16_t phi225 = 0;
					if ((phi222 & 0xf00) == 0)
					{
						phi224 = anon137 ^ (uint32_t)(phi219 & 0xffff00ff | phi212 << 8 & 0xf000 | 0xf00);
						phi225 = 256;
					}
					if ((__zext uint16_t)((uint16_t)phi224 < 4096) + phi194 + phi187 + phi167 + phi162 + (phi133 + phi129 + phi123 << 4) + phi151 + phi155 + phi183 + phi198 + phi217 + phi223 + phi225 == *(uint16_t*)(arg1 - 66))
					{
						*(uint16_t*)(anon12 + (phi111 << 1 & 0x1fffe)) = *(uint16_t*)phi112;
						phi226 = (uint16_t)phi111 + 1;
						anon227 = phi112 + 2;
						uint64_t anon229 = phi48 + 4294967295 & 0xffffffff;
