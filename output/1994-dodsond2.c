...
void s(uint64_t arg0)
{
	...
	do
	{
		...
		if (*anon4 < *phi_in1 && *anon4 < *anon6 || *anon4 >= *phi_in1 && *phi_in1 < *anon6)
		{
			*phi_in1 = *anon6;
			phi_in7 = *anon6;
		}
		if (*anon4 < *phi_in1 && *anon4 < *anon6 || *anon4 >= *phi_in1 && *phi_in1 < *anon6 || *anon4 >= *anon6 && *anon4 < *phi_in1)
		{
			if (phi_in7 > *phi_in1)
			{
				phi_in5 = *anon6;
		...
		if (phi_in5 != 255)
		{
			uint64_t anon8 = phi3 + 12;
			phi_in1 = (uint32_t*)anon8;
			phi_in2 = anon8;
			if (phi3 == 6301984)
			{
				break;
	...
	*(uint64_t*)(phi_in10 + 48) = 0;
	...
	do
	{
		...
		if (phi_in11 < *anon8)
		{
			...
			*(uint64_t*)(phi_in16 + 56) = 0;
			...
			do
			{
					...
					*(uint64_t*)(phi_in32 + 72) = 0;
					...
					do
					{
							...
							do
							{
								...
								if (*(uint32_t*)(phi_in45 + 24) < *anon49)
								{
									...
									*anon49 = *(uint32_t*)(phi_in45 + 28);
									...
									phi_in52 = phi_in36;
									phi_in53 = phi_in37;
									int64_t anon61 = (__sext int64_t)*(uint32_t*)(phi_in62 + phi_in63 + 6301632);
									int64_t anon59 = (__sext int64_t)*(uint32_t*)(phi_in60 + anon61 * 12 + 6301632);
									int64_t anon57 = (__sext int64_t)*(uint32_t*)(phi_in58 + anon59 * 12 + 6301632);
									int64_t anon56 = anon57 * 12;
									int64_t anon55 = (__sext int64_t)*(uint32_t*)(anon56 + 6301640);
									uint32_t* anon54 = (uint32_t*)((anon55 << 2) + 6300992);
									uint32_t anon64 = (uint32_t)phi_in48 + 8;
									*anon54 = anon64;
									*(uint32_t*)(phi_in65 + 88) = phi_in38;
									*(uint32_t*)(phi_in65 + 96) = phi_in39;
									*anon54 = anon64;
									phi_in14 = phi_in40;
									*(uint32_t*)(phi_in65 + 96) = phi_in41;
									*anon54 = anon64;
									*anon54 = anon64;
									*anon54 = anon64;
									phi_in66 = phi_in42;
									...
									*anon54 = anon64;
									phi_in68 = phi_in44;
									*(uint64_t*)(phi_in65 + 96) = phi_in47;
									*anon54 = anon64;
									*anon54 = anon64;
									*anon54 = anon64;
									phi_in65 = phi_in45;
									uint64_t phi_in62 = 0;
									uint64_t phi_in63 = anon50 * 12;
									phi_in69 = phi_in48;
									do
									{
										*(uint64_t*)(phi_in65 + 104) = phi_in63;
										*(uint64_t*)(phi_in65 + 80) = phi_in62;
										uint32_t* anon70 = (uint32_t*)((anon61 << 2) + 6300992);
										if (*(uint32_t*)(phi_in65 + 28) < *anon70)
										{
											*anon70 = *(uint32_t*)(phi_in65 + 40);
											*(uint32_t*)(phi_in65 + 120) = (uint32_t)phi_in69 + 9;
											phi_in60 = 0;
											*(uint64_t*)(phi_in65 + 80) = phi_in62;
											*(uint64_t*)(phi_in65 + 104) = phi_in63;
											phi_in69 = phi_in69 & 0xffffffff;
											do
											{
												uint32_t* anon71 = (uint32_t*)((anon59 << 2) + 6300992);
												if (*(uint32_t*)(phi_in65 + 40) < *anon71)
												{
													*anon71 = *(uint32_t*)(phi_in65 + 44);
													phi_in58 = 0;
													do
													{
														uint32_t* anon72 = (uint32_t*)((anon57 << 2) + 6300992);
														if (*(uint32_t*)(phi_in65 + 44) < *anon72)
														{
															*anon72 = *(uint32_t*)(phi_in65 + 64);
															int64_t anon74 = (__sext int64_t)*(uint32_t*)(anon56 + 6301636);
															uint32_t* anon73 = (uint32_t*)((anon74 << 2) + 6300992);
															if (*(uint32_t*)(phi_in65 + 64) < *anon73)
															{
																*(uint64_t*)(phi_in65 + 80) = anon74;
																if (*anon54 < *anon54)
																{
																	*(uint64_t*)(phi_in65 + 80) = anon74;
																	uint64_t anon75 = (__zext uint64_t)*anon54;
																	w(4197873, anon12, (__sext int64_t)*anon54, anon75, anon75);
																	phi_in51 = *(uint32_t*)(arg1 - 96);
																	phi_in52 = *(uint32_t*)(arg1 - 96);
																	phi_in53 = *(uint32_t*)(arg1 - 96);
																	*anon54 = *(uint32_t*)(arg1 - 68);
																	*(uint32_t*)(phi_in65 + 88) = *(uint32_t*)(arg1 - 96);
																	*(uint32_t*)(phi_in65 + 96) = *(uint32_t*)(arg1 - 96);
																	phi_in65 = anon12;
																	*anon54 = *(uint32_t*)(arg1 - 68);
																	phi_in14 = *(uint32_t*)(arg1 - 96);
																	*(uint64_t*)(phi_in65 + 80) = *(uint64_t*)(arg1 - 112);
																	*(uint32_t*)(phi_in65 + 96) = *(uint32_t*)(arg1 - 96);
																	phi_in66 = *(uint32_t*)(arg1 - 96);
																	phi_in67 = *(uint32_t*)(arg1 - 96);
																	*(uint64_t*)(phi_in65 + 80) = *(uint64_t*)(arg1 - 104);
																	phi_in68 = *(uint32_t*)(arg1 - 96);
																	*(uint64_t*)(phi_in65 + 96) = *(uint64_t*)(arg1 - 88);
																	*(uint64_t*)(phi_in65 + 104) = *(uint64_t*)(arg1 - 80);
																	phi_in69 = (__zext uint64_t)*(uint32_t*)(arg1 - 96);
																}
																int64_t anon76 = (__sext int64_t)*(uint32_t*)(*(uint64_t*)(phi_in65 + 80) * 12 + 6301636);
																if (*anon54 < *(uint32_t*)((anon76 << 2) + 6300992))
																{
																	uint64_t anon77 = (__zext uint64_t)*(uint32_t*)(phi_in65 + 120);
																	w(4197793, anon12, anon76, anon77, anon77);
																	phi_in51 = *(uint32_t*)(arg1 - 96);
																	phi_in52 = *(uint32_t*)(arg1 - 96);
																	phi_in53 = *(uint32_t*)(arg1 - 96);
																	*anon54 = alloca1.field14;
																	*(uint32_t*)(phi_in65 + 88) = *(uint32_t*)(arg1 - 96);
																	phi_in65 = anon12;
																	*(uint32_t*)(phi_in65 + 96) = *(uint32_t*)(arg1 - 96);
																	*anon54 = alloca1.field14;
																...
																int64_t anon78 = (__sext int64_t)*(uint32_t*)(*(uint64_t*)(phi_in65 + 80) * 12 + 6301640);
																if (*anon54 < *(uint32_t*)((anon78 << 2) + 6300992))
																{
																	uint64_t anon79 = (__zext uint64_t)*(uint32_t*)(phi_in65 + 120);
																	w(4197395, anon12, anon78, anon79, anon79);
																	phi_in51 = *(uint32_t*)(arg1 - 104);
																	phi_in52 = *(uint32_t*)(arg1 - 104);
																	phi_in53 = *(uint32_t*)(arg1 - 104);
																	*anon54 = *(uint32_t*)(arg1 - 80);
																	phi_in65 = anon12;
																	*(uint32_t*)(phi_in65 + 88) = *(uint32_t*)(arg1 - 104);
																	*(uint32_t*)(phi_in65 + 96) = *(uint32_t*)(arg1 - 104);
																	*anon54 = *(uint32_t*)(arg1 - 80);
																	...
																	*anon54 = *(uint32_t*)(arg1 - 80);
																	*anon54 = *(uint32_t*)(arg1 - 80);
																	phi_in66 = *(uint32_t*)(arg1 - 104);
																	*anon54 = *(uint32_t*)(arg1 - 80);
																	*anon54 = *(uint32_t*)(arg1 - 80);
																	phi_in67 = *(uint32_t*)(arg1 - 104);
																	*anon54 = *(uint32_t*)(arg1 - 80);
																	*anon54 = *(uint32_t*)(arg1 - 80);
																	*(uint64_t*)(phi_in65 + 80) = *(uint64_t*)(arg1 - 112);
																	phi_in68 = *(uint32_t*)(arg1 - 104);
																	*(uint64_t*)(phi_in65 + 96) = *(uint64_t*)(arg1 - 96);
																	*(uint64_t*)(phi_in65 + 104) = *(uint64_t*)(arg1 - 88);
																	*anon54 = *(uint32_t*)(arg1 - 80);
																	*anon54 = *(uint32_t*)(arg1 - 80);
																	*anon54 = *(uint32_t*)(arg1 - 80);
																	phi_in69 = (__zext uint64_t)*(uint32_t*)(arg1 - 104);
																}
															}
															if (*(uint32_t*)(phi_in65 + 64) < *anon54)
															{
																int64_t anon81 = anon55 * 12;
																int64_t anon80 = (__sext int64_t)*(uint32_t*)(anon81 + 6301636);
																if (*anon54 < *(uint32_t*)((anon80 << 2) + 6300992))
																{
																	uint64_t anon82 = (__zext uint64_t)*(uint32_t*)(phi_in65 + 120);
																	w(4197948, anon12, anon80, anon82, anon82);
																	phi_in51 = *(uint32_t*)(arg1 - 104);
																	phi_in52 = *(uint32_t*)(arg1 - 104);
																	phi_in53 = *(uint32_t*)(arg1 - 104);
																	*anon54 = *(uint32_t*)(arg1 - 80);
																...
																int64_t anon83 = (__sext int64_t)*(uint32_t*)(anon81 + 6301640);
																if (*anon54 < *(uint32_t*)((anon83 << 2) + 6300992))
																{
																	uint64_t anon84 = (__zext uint64_t)*(uint32_t*)(phi_in65 + 120);
																	w(4197231, anon12, anon83, anon84, anon84);
																	phi_in51 = alloca1.field8;
																	phi_in52 = alloca1.field8;
																	phi_in53 = alloca1.field8;
																	*anon54 = alloca1.field12;
																	*(uint32_t*)(phi_in65 + 88) = alloca1.field8;
																	*(uint32_t*)(phi_in65 + 96) = alloca1.field8;
																	*anon54 = alloca1.field12;
																	...
																	*anon54 = alloca1.field12;
																	*anon54 = alloca1.field12;
																	phi_in66 = alloca1.field8;
																	*anon54 = alloca1.field12;
																	*anon54 = alloca1.field12;
																	phi_in67 = alloca1.field8;
																	*anon54 = alloca1.field12;
																	*anon54 = alloca1.field12;
																	*(uint64_t*)(phi_in65 + 80) = alloca1.field7;
																	phi_in68 = alloca1.field8;
																	*(uint64_t*)(phi_in65 + 96) = alloca1.field10;
																	*(uint64_t*)(phi_in65 + 104) = alloca1.field11;
																	*anon54 = alloca1.field12;
																	*anon54 = alloca1.field12;
																	*anon54 = alloca1.field12;
																	phi_in65 = anon12;
																	phi_in69 = (__zext uint64_t)alloca1.field8;
																}
															}
														}
														phi_in58 = phi_in58 + 4;
										...
										phi85 = *(uint64_t*)(phi_in65 + 80);
										if (phi85 != 8)
										{
											phi_in62 = phi85 + 4;
											phi_in63 = *(uint64_t*)(phi_in65 + 104);
										}
									}
									while (phi85 != 8);
								}
								...
								if (phi_in46 != 8)
								{
									...
									phi_in36 = phi_in52;
									phi_in37 = phi_in53;
									phi_in38 = *(uint32_t*)(phi_in65 + 88);
									phi_in39 = *(uint32_t*)(phi_in65 + 96);
									phi_in40 = phi_in14;
									phi_in41 = *(uint32_t*)(phi_in65 + 96);
									phi_in42 = phi_in66;
									phi_in43 = phi_in67;
									phi_in44 = phi_in68;
									phi_in45 = phi_in65;
									phi_in46 = phi_in46 + 4;
									phi_in47 = *(uint64_t*)(phi_in65 + 96);
									phi_in48 = phi_in69;
								}
							}
							while (phi_in46 != 8);
							phi_in86 = *(uint64_t*)(phi_in65 + 72);
						}
						else 
						{
							phi_in51 = phi_in21;
							phi_in52 = phi_in22;
							phi_in53 = phi_in23;
							*(uint32_t*)(phi_in65 + 88) = phi_in24;
							*(uint32_t*)(phi_in65 + 96) = phi_in25;
							phi_in14 = phi_in26;
							phi_in86 = *(uint64_t*)(phi_in32 + 72);
							*(uint32_t*)(phi_in65 + 96) = phi_in27;
							phi_in66 = phi_in28;
							phi_in67 = phi_in29;
							phi_in68 = phi_in30;
							phi_in69 = phi_in31 & 0xffffffff;
							phi_in65 = phi_in32;
						}
						phi87 = phi_in86;
						if (phi87 != 8)
						{
							...
							phi_in22 = phi_in52;
							phi_in23 = phi_in53;
							phi_in24 = *(uint32_t*)(phi_in65 + 88);
							phi_in25 = *(uint32_t*)(phi_in65 + 96);
							phi_in26 = phi_in14;
							phi_in27 = *(uint32_t*)(phi_in65 + 96);
							phi_in28 = phi_in66;
							phi_in29 = phi_in67;
							phi_in30 = phi_in68;
							phi_in31 = phi_in69;
							*(uint64_t*)(phi_in32 + 72) = phi87 + 4;
							phi_in32 = phi_in65;
						}
					}
					while (phi87 != 8);
					phi_in13 = *(uint32_t*)(phi_in65 + 68);
					phi_in88 = *(uint64_t*)(phi_in65 + 56);
					phi_in89 = (__zext uint64_t)phi_in14;
					phi_in90 = *(uint32_t*)(phi_in65 + 68);
					phi_in91 = *(uint32_t*)(phi_in65 + 68);
				}
				else 
				{
					phi_in88 = *(uint64_t*)(phi_in16 + 56);
					phi_in89 = phi_in15 & 0xffffffff;
					phi_in90 = *(uint32_t*)(phi_in16 + 68);
					phi_in14 = phi_in17;
					phi_in91 = phi_in18;
					phi_in65 = phi_in16;
				}
				...
				{
					phi_in15 = phi_in89;
					*(uint32_t*)(phi_in16 + 68) = phi_in90;
					phi_in17 = phi_in14;
					phi_in18 = phi_in91;
					*(uint64_t*)(phi_in16 + 56) = phi92 + 4;
					phi_in16 = phi_in65;
				}
			}
			while (phi92 != 8);
			phi_in93 = *(uint64_t*)(phi_in65 + 48);
			phi_in94 = (__zext uint64_t)phi_in14;
		}
		else 
		{
			phi_in93 = *(uint64_t*)(phi_in10 + 48);
			phi_in14 = phi_in4;
			phi_in13 = phi_in5;
			phi_in94 = phi_in7 & 0xffffffff;
			phi_in13 = *anon8;
			phi_in14 = phi_in11;
			phi_in65 = phi_in10;
		}
		if (phi_in93 != 8)
		{
			...
			*anon8 = phi_in13;
			phi_in11 = phi_in14;
			*(uint64_t*)(phi_in10 + 48) = phi_in93 + 4;
			phi_in10 = phi_in65;
		}
	}
	while (phi_in93 != 8);
	...
	while (true)
	{
		...
		*(uint32_t*)0x602734 = 3;
		...
		do
		{
			...
			else 
			{
				...
				if (*phi_in7 < *anon13)
				{
					*phi_in7 = *anon10 & 0xf;
					phi_in11 = *anon10;
					phi_in12 = *phi_in7 & 0xf;
					*anon13 = *phi_in7;
					phi_in14 = *anon13 & 0xf;
				}
			}
			if (*anon10 >= *phi_in7 && *phi_in7 < *anon13 || *anon10 < *phi_in7 && *anon10 < *anon13)
			{
				*anon10 = *anon13;
			}
			if (*anon10 < *phi_in7)
			...
			if (*anon10 >= *phi_in7 && *phi_in7 < *anon13 || *anon10 < *phi_in7 && *anon10 < *anon13 || *anon10 < *phi_in7 && *anon10 >= *anon13)
			{
				if (phi_in11 - *anon10 <= 4294967295)
				{
					phi_in12 = *(uint32_t*)((phi9 & 0xc) - 4);
				}
			}
			...
			{
				phi_in16 = 6301636;
				uint64_t anon18 = phi9 + 12;
				phi_in7 = (uint32_t*)(anon18 & 0xc);
				phi_in8 = anon18;
				if (phi9 == 6301984)
				{
					break;
		...
		do
		{
			...
			uint32_t* anon24;
			uint32_t phi_in25;
			uint32_t* anon19 = (uint32_t*)(phi_in16 + 4);
			uint32_t* anon20 = (uint32_t*)phi_in16;
			if (*anon19 < *anon20)
			{
				*anon20 = *anon19;
				*anon19 = *anon20;
			...
			if (*anon19 >= *anon20 && *anon20 < *anon24 || *anon19 < *anon20 && *anon19 < *anon24)
			{
				phi_in25 = *anon24;
			}
			if (*anon19 < *anon20)
			...
			if ((*anon19 >= *anon20 && *anon20 < *anon24 || *anon19 < *anon20 && *anon19 < *anon24 || *anon19 < *anon20 && *anon19 >= *anon24) && phi_in22 - phi_in25 <= 4294967295)
			{
				phi_in23 = *(uint32_t*)((phi_in16 & 0xf) - 4);
			}
			uint32_t phi26 = phi_in23;
			anon27 = phi26 + 1 & 0xff;
			if (anon27 != 0)
			{
				phi_in16 = phi_in16 + 12;
			}
		}
		while (anon27 != 0);
	}
