...
void main(uint64_t arg0, uint64_t arg1)
{
	...
	*anon4 = 0;
	...
	while (true)
	{
		...
		uint32_t anon42;
		uint8_t anon43;
		uint8_t phi_in12 = phi11;
		(__asm "ucomiss xmm10, dword ptr [rip + 0x5d3]")();
		uint32_t* anon13 = (uint32_t*)0x600fc8;
		*anon13 = 33;
		(__asm "movss xmm1, dword ptr [rip + 0x200a3d]")();
		uint32_t phi_in14 = 33;
		uint64_t phi_in15 = 33;
		uint8_t phi_in16 = phi_in10;
		uint8_t phi_in17 = phi_in12;
		if ((phi_in10 | phi_in12) == 0)
		{
			uint8_t anon32;
			uint32_t anon33;
			uint32_t anon34;
			...
			{
				uint64_t phi28;
				uint32_t phi18 = phi_in14;
				uint64_t phi19 = phi_in15;
				(__asm "pxor xmm9, xmm9")();
				(__asm "pxor xmm7, xmm7")();
				(__asm "cvtsi2ss xmm9, ecx")();
				uint64_t anon23 = phi19 + 1;
				uint32_t anon22 = phi18 + (__zext uint32_t)((uint32_t)phi19 + 1 == ((uint32_t)((anon23 & 0xffffffff) / 81) - (uint32_t)(anon23 << 32 >> 32 >> 31)) * 81);
				int64_t anon21 = (__sext int64_t)anon22;
				uint8_t* anon20 = (uint8_t*)(anon21 + (arg1 + 3 & 0xf));
				*anon20 = 37;
				...
				uint64_t phi24 = anon21 >> 31 & 0xffffffff;
				uint64_t phi_in25 = 0;
				uint8_t phi26 = 1;
				uint8_t phi27 = 0;
				do
				{
					...
					if ((phi26 | phi27) == 0)
					{
						...
						*anon20 = *(uint8_t*)((phi24 << 32 >> 32) + 4197172);
						phi24 = (__zext uint64_t)*(uint8_t*)((phi24 << 32 >> 32) + 4197172);
					}
					if (phi28 != 240)
					{
						phi24 = phi24;
						...
						phi_in25 = anon30;
						phi26 = 0;
						phi27 = (__zext uint8_t)(anon30 < 236);
					}
				}
				while (phi28 != 240);
				(__asm "pxor xmm0, xmm0")();
				struct { uint32_t field0; bool field1; } anon31 = llvm.uadd.with.overflow.i32(anon22, 1);
				...
				{
					phi_in14 = anon34;
					phi_in15 = (__zext uint64_t)anon34;
				}
			}
			while (anon32 != 0);
			...
			*anon13 = anon34;
			...
			phi_in16 = (__zext uint8_t)(anon33 == 0);
			phi_in17 = anon35;
		}
		*anon4 = 4;
		uint32_t phi_in36 = 4;
		uint8_t phi37 = phi_in16;
		uint8_t phi38 = phi_in17;
		do
		{
			(__asm "pxor xmm7, xmm7")();
