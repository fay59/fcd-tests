			...
			if (dispatch18 == 2 || anon34 != null && dispatch18 == 1 && *phi22 == *anon3 && anon30 != null && anon33 == null || *phi22 != 0 && anon34 != null && dispatch18 == 0 && *phi22 == *anon3 && anon30 != null && anon33 == null)
			{
				...
				else 
				{
					...
					if (*(uint8_t*)phi37 == 92)
					{
						phi_in41 = 92;
						phi_in42 = anon43;
						uint64_t anon45 = (__zext uint64_t)*(uint8_t*)anon43 + 4294967248;
						uint8_t anon44 = (uint8_t)anon45;
						if (anon44 < 10)
						{
							phi_in41 = anon44;
							uint64_t anon46 = phi37 + 2;
							phi_in42 = anon46;
					...
					uint8_t phi54 = phi_in41;
					uint64_t phi55 = phi_in42;
					*anon40 = phi54;
					phi_in35 = phi55;
					phi_in36 = phi38 + 1;
					dispatch18 = 2;
			...
			if (*phi22 == *anon3)
			{
				if (anon30 == null)
				{
					if (dispatch18 == 1 || *phi22 != 0 && dispatch18 == 0)
					{
						*(uint8_t*)phi28 = *phi22;
						phi_in14 = anon32;
						uint64_t anon56 = phi28 + 1;
						phi_in15 = anon56;
						phi_in16 = (uint8_t*)anon56;
						phi_in17 = anon31;
						dispatch18 = 0;
					}
				}
				else if (anon33 == null)
				{
					if (anon34 == null && (dispatch18 == 1 || *phi22 != 0 && dispatch18 == 0))
					{
						...
						*(uint8_t*)(phi28 + 1) = *anon3;
						uint64_t anon57 = phi27 + 2;
						phi_in14 = anon57;
						uint64_t anon58 = phi28 + 2;
						phi_in15 = anon58;
