	...
	*anon14 = (uint32_t)((anon13 - 257 & (anon13 ^ 0x8080) & 0x8080) == 0 ? phi6 + 6 : anon8) - 3 - (__zext uint32_t)anon11.field1 - 6306624;
	...
	else 
	{
		...
		while (true)
		{
			...
			if (*phi23 == *anon3)
			{
				...
				if (anon31 != null)
				{
					...
					if (anon34 == null)
					{
						...
						if (anon35 != null && (dispatch19 == 2 || *phi23 != 0 && dispatch19 == 0))
						{
			...
			{
				*phi30 = *phi23;
				uint64_t anon39 = (uint64_t)phi30 + 1;
				phi_in24 = anon39;
				phi_in25 = anon33;
				phi_in26 = anon39;
				phi_in27 = (uint8_t*)anon39;
				dispatch19 = 2;
				if (*phi23 == 0)
				{
					break;
			...
			if (dispatch19 == 1 || anon35 != null && dispatch19 == 2 && *phi23 == *anon3 && anon31 != null && anon34 == null || *phi23 != 0 && anon35 != null && dispatch19 == 0 && *phi23 == *anon3 && anon31 != null && anon34 == null)
			{
				...
				uint8_t* anon43;
				uint64_t anon44;
				uint64_t phi40 = phi_in36;
				uint64_t phi41 = phi_in37;
				if (*(uint8_t*)phi40 == 0)
				{
				...
				{
					anon44 = phi40 + 1;
					uint8_t anon45 = *(uint8_t*)anon44 - 48;
					if (*(uint8_t*)anon44 == 57 | anon45 < 9)
					{
						uint64_t anon47 = phi40 + 2;
						uint64_t anon46 = (__zext uint64_t)*(uint8_t*)anon47 + 4294967248;
						if ((uint8_t)anon46 < 10)
						{
							uint64_t phi_in50;
							uint64_t phi_in48;
							uint64_t anon49 = anon46 + ((__zext uint64_t)*(uint8_t*)anon44 << 3) + 34359737984;
							phi_in48 = anon49;
							uint64_t anon51 = phi40 + 3;
							phi_in50 = anon51;
							if (((__zext uint8_t)(*(uint8_t*)anon51 != 57) & (__zext uint8_t)(*(uint8_t*)anon51 - 48 > 8)) == 0)
							{
			...
			if (*phi23 == *anon3)
			{
				if (anon31 == null)
				{
					if (dispatch19 == 2 || *phi23 != 0 && dispatch19 == 0)
					{
						*(uint8_t*)phi29 = *phi23;
						phi_in15 = anon33;
						uint64_t anon55 = phi29 + 1;
						phi_in16 = anon55;
						phi_in17 = (uint8_t*)anon55;
						phi_in18 = anon32;
						dispatch19 = 0;
					}
				}
				else if (anon34 == null && anon35 == null && (dispatch19 == 2 || *phi23 != 0 && dispatch19 == 0))
				{
					*anon31 = *anon3;
					*(uint8_t*)phi29 = *anon3;
					*(uint8_t*)(phi29 + 1) = *anon3;
					uint64_t anon56 = phi28 + 2;
					phi_in15 = anon56;
					uint64_t anon57 = phi29 + 2;
					phi_in16 = anon57;
					phi_in17 = (uint8_t*)anon57;
					phi_in18 = (uint8_t*)anon56;
					dispatch19 = 0;
				}
			}
		}
