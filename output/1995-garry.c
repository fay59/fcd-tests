						...
						if (anon29 == null)
						{
							...
							if (anon30 == null)
							{
								...
								*(uint8_t*)(phi23 + 1) = *anon3;
								...
								phi_in15 = anon32;
								phi16 = (uint8_t*)anon32;
								phi_in17 = (uint8_t*)anon31;
							}
							else 
							{
								uint64_t phi35;
								...
								do
								{
									...
									{
										uint64_t phi38;
										anon37 = (uint8_t*)phi36;
										*anon37 = *(uint8_t*)phi35;
										uint64_t anon39 = phi35 + 1;
										phi38 = anon39;
										if (*(uint8_t*)phi35 == 92)
										{
											*anon37 = 92;
											...
											{
												*anon37 = anon40;
												uint64_t anon41 = phi35 + 2;
												phi38 = anon41;
												uint64_t anon42 = (__zext uint64_t)*(uint8_t*)anon41 + 4294967248;
												if ((uint8_t)anon42 < 10)
												{
													uint64_t phi43;
													uint64_t anon44 = anon42 + ((__zext uint64_t)*(uint8_t*)anon39 << 3) + 34359737984;
													phi43 = anon44;
													uint64_t anon45 = phi35 + 3;
													phi38 = anon45;
													if (*(uint8_t*)anon45 - 48 < 10)
													{
														phi43 = (__zext uint64_t)*(uint8_t*)anon45 + 4294967248 + (anon44 << 3) & 0xffffffff;
														phi38 = phi35 + 4;
													}
													*anon37 = (uint8_t)phi43;
												}
											}
										}
										phi_in33 = phi38;
