	...
	else 
	{
		...
		while (true)
		{
			...
			if (*phi22 == *anon3)
			{
				...
				if (anon30 != null)
				{
					...
					if (anon33 == null)
					{
						...
						if (anon34 != null && (dispatch18 == 1 || *phi22 != 0 && dispatch18 == 0))
						{
			...
			if (dispatch18 == 2 || anon34 != null && dispatch18 == 1 && *phi22 == *anon3 && anon30 != null && anon33 == null || *phi22 != 0 && anon34 != null && dispatch18 == 0 && *phi22 == *anon3 && anon30 != null && anon33 == null)
			{
				...
				if (*(uint8_t*)phi37 == 0)
				{
					uint64_t anon39 = (uint64_t)anon30 + 1;
					phi_in14 = anon39;
					phi_in15 = phi38;
					anon40 = (uint8_t*)phi38;
					phi_in16 = anon40;
					phi_in17 = (uint8_t*)anon39;
					dispatch18 = 0;
				}
				else 
				{
					uint64_t phi_in42;
					uint8_t phi_in41 = *(uint8_t*)phi37;
					uint64_t anon43 = phi37 + 1;
					phi_in42 = anon43;
					if (*(uint8_t*)phi37 == 92)
					{
						phi_in41 = 92;
						...
						{
							phi_in41 = anon44;
							uint64_t anon45 = phi37 + 2;
							phi_in42 = anon45;
							uint64_t anon46 = (__zext uint64_t)*(uint8_t*)anon45 + 4294967248;
							if ((uint8_t)anon46 < 10)
							{
								uint64_t phi_in47;
								uint64_t phi_in49;
								uint64_t anon48 = anon46 + ((__zext uint64_t)*(uint8_t*)anon43 << 3) + 34359737984;
								phi_in47 = anon48;
								uint64_t anon50 = phi37 + 3;
								phi_in49 = anon50;
								if (*(uint8_t*)anon50 - 48 < 10)
								{
								...
								phi_in41 = (uint8_t)phi51;
								phi_in42 = phi52;
							}
						}
					}
					uint8_t phi53 = phi_in41;
					uint64_t phi54 = phi_in42;
					*anon40 = phi53;
					phi_in35 = phi54;
					phi_in36 = phi38 + 1;
					dispatch18 = 2;
			...
			if (*phi22 == *anon3)
			{
				if (anon30 == null)
				{
					if (dispatch18 == 1 || *phi22 != 0 && dispatch18 == 0)
					{
						*(uint8_t*)phi28 = *phi22;
						phi_in14 = anon32;
						uint64_t anon55 = phi28 + 1;
						phi_in15 = anon55;
						phi_in16 = (uint8_t*)anon55;
						phi_in17 = anon31;
						dispatch18 = 0;
					}
				}
				else if (anon33 == null)
				{
					if (anon34 == null && (dispatch18 == 1 || *phi22 != 0 && dispatch18 == 0))
					{
						...
						*(uint8_t*)(phi28 + 1) = *anon3;
						uint64_t anon56 = phi27 + 2;
						phi_in14 = anon56;
						uint64_t anon57 = phi28 + 2;
						phi_in15 = anon57;
