			...
			if (anon10 != null)
			{
				...
				while (true)
				{
					...
					if (*(uint64_t*)(*anon19 + anon20) != 0)
					{
						...
						if ((uint32_t)*anon19 != 0)
						{
							break;
							phi_in18 = *(uint64_t*)(phi21 + 16);
						}
					}
					if (*(uint64_t*)(*anon19 + anon20) == 0 || *(uint64_t*)(*anon19 + anon20) != 0 && (uint32_t)*anon19 != 0 && *(uint64_t*)(phi21 + 16) == 0)
					{
						uint8_t* anon22 = _strdup(anon10);
						uint8_t* anon23 = _malloc(24);
						*(uint64_t*)anon23 = (uint64_t)anon22;
						uint64_t anon24 = (uint64_t)anon23;
						*(uint64_t*)(anon24 + 8) = 0;
						*(uint64_t*)(anon24 + 16) = *(uint64_t*)(*anon19 + anon20);
						*(uint64_t*)(*anon19 + anon20) = anon24;
						uint32_t* anon25 = (uint32_t*)*phi7;
						*anon25 = *anon25 + 1;
					}
				}
			}
...
void _main(uint64_t arg0, uint64_t arg1, uint64_t arg2, uint64_t arg3)
{
	...
	*(uint32_t*)0x1000020c4 = (uint32_t)(anon7 >> 32);
	...
	else 
	{
		...
		*anon20 = phi15;
		...
		phi13 = phi13;
		uint64_t phi26 = phi16 & 0xff | 0x100;
		...
		if (((__zext uint32_t)phi10 << 8 | (__zext uint32_t)phi11) != 0)
		{
			...
			if (anon29 != null)
			{
				...
				if (anon34 != null)
				{
					...
					uint24_t phi_in58 = phi57;
					uint64_t phi_in59 = phi45;
					phi_in31 = phi_in58;
			...
			phi13 = phi_in60;
			phi26 = (__zext uint64_t)*anon20;
			phi28 = (uint8_t)(*anon20 >> 8);
		}
		phi10 = phi24;
		phi_in12 = phi25;
		uint64_t phi_in17 = phi26;
		uint64_t phi_in19 = phi27;
		phi11 = phi28;
		phi8 = anon21;
		phi9 = phi_in17;
	}
	...
	*anon63 = anon64;
	...
	uint64_t anon66 = anon55 - ((anon64 << 3) + 15 & 0xffffffff0);
	*anon65 = anon66;
