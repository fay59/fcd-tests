		...
		*(uint32_t*)(arg1 - 340) = 0;
		...
		do
		{
			...
			*anon20 = phi16;
			...
			struct x86_regs* anon22 = (struct x86_regs*)*(uint64_t*)(phi_in17 + anon23);
			_strcmp.47(anon22);
			...
			{
				_strcmp.47(anon22);
				uint8_t* anon28 = (uint8_t*)*(uint64_t*)(phi_in17 + anon23);
				uint8_t* anon27 = _strrchr(anon28, 46);
				uint24_t phi29 = 0;
				alloca1.field5 = phi_in17;
				uint64_t phi_in30 = phi_in18;
				if (anon27 != null)
				{
					struct __sFILE* anon34 = _fopen(anon28, (uint8_t*)0x100001c1c);
						...
						*(uint64_t*)anon35 = anon33;
						...
						while (true)
						{
							...
							if (phi39 == 0 || anon47 != 1 && phi39 != 0 && anon32 == 0 || phi39 != 0 && anon47 == 1 && anon32 == 0)
							{
								...
								anon52 = arg1 - 400;
								_store_path(4294971047, anon52, *(uint64_t*)(alloca1.field5 + anon23), phi41);
								do
								{
			...
			if (anon56 != anon57)
			{
				...
				phi15 = phi9;
				phi_in19 = phi26;
				phi16 = (__zext uint32_t)phi10 << 8 | (__zext uint32_t)phi11;
			}
		}
		while (anon56 != anon57);
	}
...
void _table_print(uint64_t arg0, uint64_t arg1, uint64_t arg2)
{
	...
	if (*anon3 != 0)
	{
		...
		while (anon8 < (__zext uint64_t)phi2);
	}
	return;
}
