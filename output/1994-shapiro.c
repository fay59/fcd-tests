...
void main(uint64_t arg0)
{
	...
	while (true)
	{
		...
		if (((__zext uint8_t)(phi7 != 89) & (__zext uint8_t)(anon8 > 14)) == 0)
		{
			if ((uint32_t)phi2 == 1)
			{
				if (dispatch3 == 1 || anon6 != 255 && dispatch3 == 0)
				{
					_IO_putc(anon8 << 4 | (uint32_t)phi_in5 - 74, *(struct _IO_FILE**)0x600ac0);
					phi_in5 = phi_in5 & 0xffffffff;
