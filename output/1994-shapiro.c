	...
	do
	{
		...
		if (anon7 != 255)
		{
			...
			if (anon11 < 16)
			{
				...
				{
					_IO_putc(anon11 << 4 | (uint32_t)phi_in3 - 74, *(struct _IO_FILE**)0x600ac0);
					phi_in4 = phi_in3 & 0xffffffff;
					phi2 = phi_in6 & 0xffffffffffffff00;
				}
				else 
				{
